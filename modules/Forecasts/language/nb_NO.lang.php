...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}.<br><br>Merk at innstillinger for område ikke kan endres etter første lagring. For oppgraderte instanser er områdeinnstillingen låst sammen med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på sannsynlighetsområder eller opprette kategorier som ikke er basert på sannsynlighet.<br><br>Det er avmerkingsbokser til venstre for dine tilpassede kategorier; bruk disse til å velge hvilke områder som skal inkluderes mer prognosetallet som lagres og rapporteres til ledere.<br><br>En bruker kan endre status inkluder/ekskluder og kategorien til {{forecastByModule}} manuelt fra arbeidsarket.',
