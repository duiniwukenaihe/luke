...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Vänligen observera att de olika intervallinställningarna inte kan ändras efter det första utförandet. För uppgraderade instanser är intervallinställningen låst in med befintlig prognosdata. <br><br>Du kan välja två eller fler kategorier baserat på sannolikhetsintervall eller skapa kategorier som inte baseras på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; använd dessa för att bestämma vilka intervall som kommer att inkluderas inom det utförda prognosbeloppet och rapportera till chefer. <br><br>En användare kan ändra inkludera/utesluta statusen och kategorin av {{forecastByModule}} manuellt från sina kalkylblad.',
