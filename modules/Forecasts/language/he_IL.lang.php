...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'הגדר כיצד תרצה לסווג {{forecastByModule}}. <br><br> נא שם לב שאי אפשר לשנות את ההגדרות הטווח לאחר מכן. עבור מופעים משודרגים, הגדרות הטווח נעולים עם נתוני &#39;תחזית&#39; קיימים.<br><br>יש לך את האפשרות לבחור בשתי קטגוריות או יותר בהתבססות על טווח ההסתברות, או ביכולתך ליצור קטגוריות שלא מבוססות על הסתברות. <br><br>ישנם תיבות סימון בצד השמאלי של הקטגוריות המותאמות באופן אישי; השתמש בהם כדי להחליט אילו טווחים יהיו כלולים בכמות התחזית המחויבת והמדווחת למנהלים.<br><br> ביכולתו של המשתמש לשנות את מצב הכלול/ לא כלול ואת קטגורית ה-{{forecastByModule}} באופן ידני מגליונות עבודתו.',
