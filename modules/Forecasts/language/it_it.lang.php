...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configurare il modo in cui si desidera effettuare la categorizzazione {{forecastByModule}}. <br><br>Tenere presente che le impostazioni Range (Intervallo) non possono essere modificate dopo il primo commit. Per le istanze aggiornate, l&#39;impostazione Range è bloccata insieme ai dati di previsione esistenti.<br><br>È possibile selezionare due o più categorie basate sugli intervalli delle probabilità oppure creare categorie che non siano basate sulla probabilità. <br><br>A sinistra delle categorie personalizzate sono presenti delle caselle di spunta: utilizzarle per decidere quali intervalli includere in Importi previsti approvati e segnalati ai manager. <br><br>L&#39;utente può cambiare manualmente lo stato di inclusione/esclusione e la categoria di {{forecastByModule}} dal proprio foglio di lavoro.',
