...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดวิธีการที่คุณต้องการจัดประเภท {{forecastByModule}}<br><br>กรุณารับทราบว่าไม่สามารถเปลี่ยนแปลงการตั้งค่าช่วงได้หลังจากการยอมรับครั้งแรกแล้ว สำหรับอินสแตนศ์ที่อัพเกรดแล้ว การตั้งค่าช่วงจะถูกล็อกด้วยข้อมูลการคาดการณ์ที่มีอยู่<br><br>คุณอาจเลือกสองหมวดหรือมากกว่าตามช่วงความน่าจะเป็น หรือสร้างหมวดที่ไม่ได้เป็นไปตามความน่าจะเป็น<br><br>มีกล่องกาเครื่องหมายอยู่ทางซ้ายของหมวดกำหนดเองของคุณ; ใช้สิ่งเหล่านี้ในการตัดสินใจว่าช่วงไหนที่จะรวมอยู่ในจำนวนการคาดการณ์ที่จะถูกยอมรับและรายงานแก่ผู้จัดการ<br><br>ผู้ใช้อาจเปลี่ยนสถานะและหมวดรวม/ไม่รวมของ {{forecastByModule}} ด้วยตนเองจากแผ่นงานของพวกเขา',
