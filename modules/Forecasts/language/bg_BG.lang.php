...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Конфигурирайте категоризацията на {{forecastByModule}} според вашите предпочитания. <br><br>Моля, обърнете внимание, че Настройките на обхвата не могат да бъдат променяни след първото потвърждение. За актуализирани инсталации Настройката на обхвата е заключена в съществуващите Прогнозни данни.<br><br>Можете да изберете две или повече категории въз основа на обхватите на вероятностите или да създадете категории, които не са основани на вероятности. <br><br>Има квадратчета за отметки в ляво от вашите потребителски категории; използвайте ги, за да решите кои обхвати да бъдат включени в Прогнозната изпратена сума и докладвани на мениджърите. <br><br>Потребителят може да промени статуса за включване/изключване и категорията на {{forecastByModule}} ръчно от плана си.',
