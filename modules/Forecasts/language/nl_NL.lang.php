...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt indelen. <br><br>Houd er rekening mee dat de bereikinstellingen na de eerste keer vastleggen niet meer kunnen worden veranderd. Voor nieuwe gevallen is de bereikinstelling vergrendeld in de huidige prognosegegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van waarschijnlijkheidsbereik of u kun categorieën aanmaken die niet zijn gebaseerd op waarschijnlijkheid. <br><br>Er zijn selectievakjes links van uw aangepaste categorieën. Gebruik deze om aan te geven welk bereik wordt opgenomen in het toegewezen prognosecijfer en aan managers wordt gerapporteerd. <br><br>Een gebruiker kan de status opnemen/uitsluiten en een categorie {{forecastByModule}} handmatig veranderen in het werkblad.',
