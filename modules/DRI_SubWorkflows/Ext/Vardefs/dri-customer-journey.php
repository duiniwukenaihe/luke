...
$dictionary['DRI_SubWorkflow']['indices']['idx_dri_subworkflow_template_id'] = array (
...
$dictionary['DRI_SubWorkflow']['indices']['idx_dri_workflow_id'] = array (
  'name' => 'idx_dri_workflow_id',
  'type' => 'index',
  'fields' => 
  array (
    0 => 'dri_workflow_id',
...
$dictionary['DRI_SubWorkflow']['acls']['SugarACLCustomerJourney'] = true;
