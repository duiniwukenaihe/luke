...
class DRICustomerJourneyTemplatesImportExportApi extends ExportApi
{
    ...
    public function registerApiRest()
    {
        return array(
            'templateImportPost' => array(
                ...
                'acl' => 'create',
                'shortHelp' => 'Imports a Customer Journey Template from a .json file',
            ),
            ...
            'exportGet' => array(
                ...
                'shortHelp' => 'Exports a Customer Journey Template in .json format.',
            ),
        );
    }
    ...
    private function getUploadFileName(array $args)
    {
        ...
        if (!$bean->ACLAccess('save') || !$bean->ACLAccess('import')) {
            throw new SugarApiExceptionNotAuthorized('No access to import Customer Journey Templates');
        }
    ...
    public function export(ServiceBase $api, array $args = array())
    {
        ...
        if (!$bean->ACLAccess('export')) {
            throw new SugarApiExceptionNotAuthorized('No access to export Customer Journey Templates');
        }
