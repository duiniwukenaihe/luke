...
,
'LBL_POPHELP_CALCULATED'=>"Izveidot formulu, lai noteiktu, vai šis lauks ir redzams izkārtojumos. <br>"
   . "Darbplūsmas definīcijas, kas satur darbību, kuras ir iestatītas, lai atjauninātu šo lauku, vairs nepildīs šo darbību.<br>"
   . "Lauki, kas izmanto formulas, netiks aprēķināti reālā laikā "
   . "Sugar pašapkalpošanās portālā vai "
   . "Mobile EditView izkārtojumos.",

'LBL_POPHELP_DEPENDENT'=>"Izveidot formulu, lai noteiktu, vai šis lauks ir redzams izkārtojumos. <br/>"
        . "Atkarīgie lauki ievēros atkarības formulu uz pārlūka bāzētajā mobilajā skatījumā,<br/>"
        . "bet neievēros formulu oriģinālajās lietotnēs, piemēram, Sugar Mobile, kas paredzēta iPhone. <br/>"
        . "Tie neievēros formulu Sugar pašapkalpošanās portālā.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Atlasiet, lai izmantotu šo lauku ierakstu meklēšanai, izmantojot globālo meklēšanu šajā modulī.',
