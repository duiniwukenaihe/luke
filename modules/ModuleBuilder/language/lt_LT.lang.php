...
'LBL_CONFIRM_FIELD_DELETE'=>'Pašalinus šį pasirinktinį lauką bus pašalintas ir laukas, ir visi su pasirinktiniu lauku susiję duomenys duomenų bazėje. Laukas nebebus rodomas nė viename modulio makete.'
        ...
        . '\\n\\nAr norite tęsti?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Ar tikrai norite ištrinti šiuos ryšius?<br>Pastaba. Ši operacija gali užrukti keletą minučių.',
...
,
'LBL_POPHELP_CALCULATED'=>"Norėdami nustatyti šio lauko reikšmę, sukurkite formulę.<br>"
   . "Vykdant darbo eigos apibrėžimus, į kuriuos yra įtraukti veiksmai, skirti atnaujinti šį lauką, šie veiksmai nebebus vykdomi.<br>"
   . "Laukų, kuriuose naudojamos formulės, reikšmės nebus apskaičiuotos realiuoju laiku "
   . "naudojant „Sugar“ savitarnos portalo arba "
   . "mobiliesiems įrenginiams skirto redagavimo rodinio išdėstymus.",

'LBL_POPHELP_DEPENDENT'=>"Norėdami nustatyti, ar šis laukas rodomas išdėstymuose, sukurkite formulę.<br>"
        . "Priklausomybės formulė bus taikoma priklausomiems laukams naršyklės mobiliajame rodinyje, <br/>"
        . "tačiau ne vietinėse programose, pvz., „Sugar Mobile“, skirtoje „iPhone“. <br/>"
        . "Jiems nebus taikoma „Sugar“ savitarnos portalo formulė.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Pasirinkite naudoti šį lauką, naudodami visuotinę paiešką ieškote įrašų šiame modulyje.',
