...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        'defaultquickcreate'=>'Ala <b>Paigutus</b> sisaldab hetkel <b>Kiirloome</b> vormis näidatavaid välju.<br><br>Kiirloome vorm ilmub mooduli alampaneelidesse, kui klõpsatakse nuppu Loo.<br/><br/><b>Tööriistakast</b> sisaldab <b>Prügikasti</b> ning välju ja elemente, mida on võimalik paigutusse lisada.<br><br>Paigutust saate muuta, lohistades elemente ja välju <b>Tööriistakasti</b> ja <b>Paigutuse</b> vahel ning ka paigutuse enda sees.<br><br>Et välja paigutusest eemaldada, lohistage see <b>Prügikasti</b>. Seejärel muutub väli tööriistakastis kättesaadavaks ja paigutusse lisatavaks.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tähistab sõltuvat välja, mis võib, aga ei pruugi olla nähtav, olenevalt valemi väärtusest.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tähistab kalkuleeritud välja, mille väärtus määratakse automaatselt valemi abil.'
    ,
        //this defualt will be used for edit view
        'default'	=> 'Ala <b>Paigutus</b> sisaldab välju, mis on hetkel nähtavad <b>Redigeerimisvaates</b>.<br/><br/><b>Tööriistakast</b> sisaldab <b>Prügikasti</b> ning välju ja elemente, mida on võimalik paigutusse lisada.<br><br>Paigutust saate muuta, lohistades elemente ja välju <b>Tööriistakasti</b> ja <b>Paigutuse</b> vahel ning ka paigutuse enda sees.<br><br>Et välja paigutusest eemaldada, lohistage see <b>Prügikasti</b>. Seejärel muutub väli tööriistakastis kättesaadavaks ja paigutusse lisatavaks.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tähistab sõltuvat välja, mis võib, aga ei pruugi olla nähtav, olenevalt valemi väärtusest.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tähistab kalkuleeritud välja, mille väärtus määratakse automaatselt valemi abil.'
    ,
        //this defualt will be used for edit view
...
'LBL_CONFIRM_FIELD_DELETE'=>'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses.'
        ...
        . '\\n\\nKas soovite jätkata?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Kas soovite kindlasti selle seose kustutada?<br>Märkus: see toiming võib võtta mitu minutit.',
...
'LBL_POPHELP_CALCULATED'=>"Looge valem, et määrata selle välja väärtus.<br>"
   . "Töövoo definitsioonid, mis sisaldavad toimingut selle välja muutmiseks, ei vii enam toimingut täide.<br>"
   . "Valemeid kasutavaid välju ei kalkuleerita reaalajas"
   . "Sugari iseteeninduse portaalis ega "
...
'LBL_POPHELP_DEPENDENT'=>"Looge valem, et määrata, kas see väli on paigutustes nähtav.<br/>"
        . "Sõltuvad väljad järgivad sõltuvusvalemit, kui kasutatakse veebilehitsejal põhinevat mobiilivaadet, <br/>"
        . "kuid ei järgi valemit omarakendustes nagu iPhone’ile mõeldud Sugar Mobile. <br/>"
        . "Valemit ei järgita Sugari iseteeninduse portaalis.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Valige, et kasutada seda välja kõikehõlmava otsinguga selle mooduli kirjeid otsides.',
