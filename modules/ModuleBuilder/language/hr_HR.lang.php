...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.'
    ,
        'defaultquickcreate'=>'Područje <b>Izgleda</b> sadrži polja koja se trenutačno prikazuju unutar obrasca <b>Brzo stvaranje</b>.<br><br>Obrazac Brzo stvaranje pojavljuje se u podpločama modula kada se klikne na gumb Stvori.<br/><br/><b>Alatni okvir</b> sadrži <b>Koš za smeće</b> te polja i elemente izgleda koji se mogu dodati izgledu.<br><br>Promijenite izgled tako da povučete i ispustite elemente i polja između <b>Alatnog okvira</b> i <b>Izgleda</b> i unutar samog izgleda.<br><br>Da biste uklonili polje iz izgleda, dovucite polje u <b>Koš za smeće</b>. Polje će zatim biti dostupno u Alatnom okviru radi dodavanja izgledu.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora biti vidljivo na temelju vrijednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava izračunato polje čija će se vrijednost automatski odrediti na temelju formule.'
    ,
...
,
'LBL_POPHELP_CALCULATED'=>"Stvaranje formule za određivanje vrijednosti u ovom polju.<br>"
   . "Definicije tijeka rada koje sadrže radnju, a kojima se ažurira ovo polje više neće izvršavati tu radnju. <br>"
   . "Polja u kojima se koriste formule neće se izračunati u stvarnom vremenu na "
   . "samouslužnom portalu Sugar ili "
   . "izgledima mobilnog prikaza za uređivanje.",

'LBL_POPHELP_DEPENDENT'=>"Stvaranje formule za određivanje vidljivosti ovog polja na izgledima.<br/>"
        . "U zavisnim poljima slijedit će se formula zavisnosti s mobilnog prikaza u pregledniku,<br/>"
        . "no formula se neće slijediti u izvornim aplikacijama kao što je Sugar Mobile za iPhone.<br/>"
        . "U njima se neće slijediti formula sa samouslužnog portala Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Odaberite kako biste ovo polje upotrijebili pri globalnom pretraživanju zapisa u ovom modulu.',
