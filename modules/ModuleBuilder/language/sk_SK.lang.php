...
'help'=>array(
    ...
    . '<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.'
    ,
        'defaultquickcreate'=>'Oblasť <b>Rozloženie</b> obsahuje polia, ktoré sa momentálne zobrazujú v časti formulára <b>Rýchle vytvorenie</b>.<br><br>Formulár Rýchle vytvorenie sa objaví v pod-paneli pre modul po kliknutí na tlačidlo Vytvoriť.<br/><br/> Časť <b>Nástroje</b> obsahuje <b>Kôš</b> a polia a prvky rozloženia, ktoré do rozloženia možno pridať. <br><br>Vykonajte zmeny v rozložení pretiahnutím prvkov a polí medzi časťami <b>Nástroje</b> a <b>Rozloženie</b> a v rámci samotného rozloženia.<br> <br>Ak chcete pole z rozloženia odstrániť, pretiahnite pole do priečinka <b>Kôš</b>. Pole potom bude k dispozícii v časti Nástroje na prípadne pridanie do rozloženia.'
    . '<br/> <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca. <br/> <!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.'
    ,
        //this defualt will be used for edit view
        'default'	=> 'Oblasť <b>Rozloženie</b> obsahuje polia, ktoré sa momentálne zobrazujú v časti <b>Zobrazenie úprav</b>. <br/> <br/> Časť <b>Nástroje</b> obsahuje <b>Kôš</b> a polia a prvky rozloženia, ktoré do rozloženia možno pridať. <br><br>Vykonajte zmeny v rozložení pretiahnutím prvkov a polí medzi časťami <b>Nástroje</b> a <b>Rozloženie</b> a v rámci samotného rozloženia. <br> <br>Ak chcete pole z rozloženia odstrániť, pretiahnite pole do priečinka <b>Kôš</b>. Pole potom bude k dispozícii v časti Nástroje na prípadne pridanie do rozloženia.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/> Označuje závislé pole, ktoré môže alebo nemusí byť viditeľné v závislosti od hodnoty vzorca.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočítavané pole, ktorého hodnota sa automaticky určí na základe vzorca.'
    ,
        //this defualt will be used for edit view
...
'LBL_CONFIRM_FIELD_DELETE'=>'Vymazaním tohto vlastného poľa odstránite vlastné pole a všetky údaje súvisiace s vlastným poľom v databáze. Pole sa už nebude zobrazovať v žiadnom z rozložení modulu.'
        ...
        . '\\n\\nChcete pokračovať?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Naozaj chcete vymazať tento vzťah?<br>Poznámka: Ukončenie tejto operácie nemusí prebehnúť do niekoľkých minút.',
...
,
'LBL_POPHELP_CALCULATED'=>"Vytvoriť vzorec pre určenie hodnoty v tomto poli.<br>"
   . "Pracovný tok definícií obsahujúci akciu, ktorú ste nastavili na aktualizáciu tohto poľa už nevykoná túto akciu.<br>"
   . "Polia obsahujúce vzorce nebudú vypočítavané v reálnom čase v "
   . "Servisnom portáli Sugar ani "
   . "v rozloženiach mobilného Zobrazenia úprav.",

'LBL_POPHELP_DEPENDENT'=>"Vytvoriť vzorec pre určenie, či toto pole bude viditeľné v rozloženiach.<br/>"
        . "Závislé polia budú nasledovať vzorec závislosti v mobilnom zobrazení prehliadača, <br/>"
        . "ale to nebude nasledovať vzorec v pôvodnej aplikácií, ako je Sugar Mobile pre iPhone. <br/>"
        . "Nebudú nasledovať vzorec v Sugar Self-Service Portal.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Vyberte použitie tohto poľa pri prehľadávaní záznamov použitia Global Search na tomto module.',
