...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Określa pole zależne, które może być widoczne lub niewidoczne w zależności od wartości wzoru.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Określa obliczone pole, którego wartość zostanie automatycznie określona na podstawie wzoru.'
    ,
        'defaultquickcreate'=>'Obszar <b>Layout</b> zawiera pola, które są obecnie wyświetlane w formularzu<b>QuickCreate</b>.<br><br>Formularz QuickCreate pojawia się w podpanelu dla modułu po kliknięciu przycisku Utwórz.<br/><br/><b>Przybornik</b> zawiera <b>Kosz</b> i pola oraz elementy układu, które można dodawać do układu.<br><br>Dokonaj zmian układu przeciągając i upuszczając elementy i pola między <b>Przybornikiem</b> a pozycją <b>Układ</b> i w obrębie samego układu.<br><br>Aby usunąć pole z układu, przeciągnij pole do <b>Kosza</b>. Pole będzie wówczas gotowe w przyborniku na dodanie nowego układu.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Wskazuje zależne pole, które może być widoczne lub nie w zależności od wartości z formuły.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Wskazuje obliczane pole, którego wartość zostanie określona automatycznie w oparciu o formułę.'
    ,
        //this defualt will be used for edit view
        'default'	=> 'Obszar <b>Układ</b> zawiera pola, które są aktualnie wyświetlane w ramach formularza <b>Widok szczegółowy</b>.<br/><br/>Obszar <b>Narzędzia</b> zawiera <b>Kosz</b> oraz pola i elementy układu, które można dodać do układu.<br><br>Zmiany w układzie wprowadza się, przeciągając elementy i upuszczając je pomiędzy obszarami <b>Narzędzia</b> i <b>Układ</b> oraz z samym układzie.<br><br>Aby usunąć pole z układu, przeciągnij pole do <b>Kosza</b>. Pole będzie wówczas dostępne w obszarze Narzędzia do dodania do układu.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Wskazuje zależne pole, które może być widoczne lub nie w zależności od wartości z formuły.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Wskazuje obliczane pole, którego wartość zostanie określona automatycznie w oparciu o formułę.'
    ,
        //this defualt will be used for edit view
...
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Czy na pewno chcesz usunąć tę relację? <br>Uwaga: Ta operacja może potrwać kilka minut.',
...
'LBL_POPHELP_CALCULATED'=>"Utwórz formułę do określenia wartości w tym polu. <br>"
   . "Zawierające działania definicje procesu, które są ustawione tak, aby aktualizować to pole, przestaną wykonywać to działanie. <br>"
   . "Pola używające formuł nie będą obliczane w czasie rzeczywistym w "
   . "portalu samoobsługowym Sugar lub "
   . "układach Mobile EditView.",

'LBL_POPHELP_DEPENDENT'=>"Utwórz formułę do określania, czy to pole będzie widoczne w układach. <br/>"
        . "Pola zależne będą śledzić formułę zależności w przeglądarce widoku dla urządzeń przenośnych, <br/>"
        . "ale nie będą śledzić formuł w natywnych aplikacjach, takich jak Sugar Mobile for iPhone. <br/>"
        . "Nie będą śledzić formuł w portalu samoobsługowego Sugar.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Zaznacz, aby użyć tego pola podczas wyszukiwania rekordów przy użyciu wyszukiwanie globalne w module.',
