...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} ви дава възможност да проследявате отделните продажби и приходните позиции, асоциирани с тях. Всеки запис в модула {{module_name}} представлява потенциална продажба и включва съответните данни за продажбата, като в същото време предоставя и връзка към други важни записи като {{quotes_module}}, {{contacts_module}} и други.
...
- Поставете и разгледайте потребителски коментари и запаметете историята на извършените промени в {{activitystream_singular_module}} чрез показване на "Хронология" в долния ляв панел.
