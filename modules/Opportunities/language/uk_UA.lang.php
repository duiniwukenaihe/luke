...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} дозволяє відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} є потенційним продажем і містить відповідні дані про продаж, а також відноситься до інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. Кожен модуль {{module_name}} проходить кілька стадій продажу, доки його не буде позначено як «Успішно закритий» або «Втрачений». Модуль {{plural_module_name}} можна застосовувати з більшою користю, використовуючи модуль {{forecasts_singular_module}} системи Sugar для розуміння та прогнозування тенденцій продажів, а також зосередження роботи на досягненні квот продажу.',
...
- Щоб залишати та переглядати коментарі користувачів, а також історію зміни запису в модулі {{activitystream_singular_module}}, переключіть ліву нижню панель на «Потік активності».
- Щоб підписатися на цей запис або додати його до вподобань, використовуйте значки праворуч від його імені.
...
Щоб створити модуль {{module_name}}, виконайте такі дії:
1. Укажіть потрібні значення полів.
 - Перед збереженням потрібно заповнити поля з позначкою «Обов&#39;язково».
 - Щоб відобразити додаткові поля, натисніть кнопку «Показати більше».
