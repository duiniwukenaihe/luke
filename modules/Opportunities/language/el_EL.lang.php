...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η μονάδα {{plural_module_name}} σας δίνει τη δυνατότητα να παρακολουθείτε τις πωλήσεις μία προς μία, από την αρχή μέχρι το τέλος. Κάθε αρχείο {{module_name}} αντιπροσωπεύει μία πιθανή πώληση και περιλαμβάνει σχετικά δεδομένα πώλησης, καθώς και δεδομένα που σχετίζονται με άλλα σημαντικά αρχεία, όπως για παράδειγμα {{quotes_module}}, {{contacts_module}}, etc. Μία {{module_name}} τυπικά θα διέλθει διάφορα Στάδια Πώλησης μέχρι που να σημανθεί ως είτε "Έκλεισε Κερδισμένη Πώληση" ή "Έκλεισε Χαμένη Πώληση". Η μονάδα {{plural_module_name}} μπορεί να ενισχυθεί ακόμη περισσότερο με χρήση της μονάδας {{forecasts_singular_module}} του Sugar για να γίνουν κατανοητές οι τάσεις πωλήσεων και να δοθεί η δυνατότητα σύνταξης προβλέψεων, καθώς και η εστίαση της προσπάθειας για επίτευξη των ποσοστώσεων πωλήσεων.',
 ...
 - Τροποποιήστε τα πεδία του πεδίου κάνοντας κλικ σε ένα ξεχωριστό πεδίο ή στο πλήκτρο Τροποποίηση. - Εμφανίστε ή τροποποιήστε συνδέσμους σε άλλα αρχεία στους υποπίνακες εναλλάσσοντας το κάτω αριστερό παράθυρο σε "Απεικόνιση Δεδομένων". 
- Αλληλεπιδράστε με τα σχόλια των χρηστών και την προβολή του ιστορικού των αλλαγών των εγγραφών {{activitystream_singular_module}} από την εναλλαγή του κάτω αριστερού παραθύρου σε "Ροή Δραστηριοτήτων". 
