...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות מתחילתן ועד לסיומן. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתוני מכירות רלוונטיים וכן רשומות חשובות נוספות כגון {{quotes_module}}, {{contacts_module}}, וכו&#39;. {{module_name}} יתקדם בדרך כלל במשך כמה שלבי מכירה עד שיסומן כ"נסגר בהצלחה" או "נסגר ואבד". ניתן למנף את {{plural_module_name}} אפילו יותר על ידי שימוש במודול {{forecasts_singular_module}} של Sugar כדי להבין ולחזות את מגמות המכירות וכדי למקד את העבודה לקבלת מכסות מכירות.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות וסעיפים נפרדים השייכים למכירות אלה מתחילתן ועד לסיומן. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתוני מכירות רלוונטיים וכן אלה הקשורים לרשומות חשובות נוספות כגון {{quotes_module}}, {{contacts_module}}, וכו&#39;.

- ערוך את שדות הרשומה בלחיצה על כל שדה בודד או על הלחצן "ערוך".
- הצג או שנה קישורים לרשומות אחרות בלוחות המשנה על ידי החלפת החלון השמאלי התחתון ל"תצוגת נתונים".
- כתוב והצג הערות משתמש והקלט את היסטוריית השינויים ב{{activitystream_singular_module}} על ידי החלפת החלון השמאלי התחתון ל"זרם פעילות".
- עקוב אחר רשומה זו או הוסף אותה לרשימת המועדפים על ידי השימוש בסמלים שמימין לשם הרשומה.
- פעולות נוספות זמינות בתפריט הפעולות הנגלל מימין ללחצן "ערוך".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחרי מכירות בודדות והסעיפים הנפרדים השייכים למכירות אלה מתחילתן ועד לסיומן. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית וכוללת נתוני מכירות רלוונטיים וכן אלה הקשורים לרשומות חשובות נוספות כגון {{quotes_module}}, {{contacts_module}}, וכו&#39;.
