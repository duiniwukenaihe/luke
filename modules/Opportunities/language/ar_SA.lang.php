...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'الوحدة النمطية {{plural_module_name}} تسمح لك بتعقب المبيعات الفردية من البداية إلى النهاية. كل سجل {{module_name}} يمثل بيع المحتملين، ويتضمن بيانات البيع ذات الصلة وكذلك المتعلقة بسجلات هامة أخرى مثل {{quotes_module}}، {{contacts_module}}، إلخ. وسوف تقدم {{module_name}} عادة عبر عدة "مراحل المبيعات" حتى يتم وضع علامة "فاز مغلقة" أو "فقد أغلقت". يمكن أن تكون الاستدانة {{plural_module_name}} أكثر فأكثر باستخدام الوحدة النمطية {{forecasts_singular_module}}ing للسكر إلى فهم والتنبؤ باتجاهات المبيعات، فضلا عن التركيز على العمل من أجل تحقيق حصص المبيعات.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'الوحدة النمطية {{plural_module_name}} تسمح لك بتعقب المبيعات الفردية وعناصر الخط التي تنتمي إلى عمليات البيع هذه من البداية إلى النهاية. كل سجل {{module_name}} يمثل عملية بيع محتملة، ويتضمن بيانات البيع ذات الصلة، وكذلك البيانات المتعلقة بسجلات هامة أخرى مثل {{quotes_module}}، {{contacts_module}}، إلخ. - تحرير حقول هذا السجل بواسطة النقر فوق حقل مفرد أو الزر "تحرير". - عرض أو تعديل الارتباطات إلى سجلات أخرى في اللوحات الفرعية عن طريق تبديل الجزء الأيسر السفلي إلى "طريقة عرض البيانات". - عمل وعرض تعليقات المستخدم وسجل تغيير السجل في {{activitystream_singular_module}} عن طريق تبديل الجزء الأيسر السفلي إلى "تيار النشاط". - متابعة أو الإضافة إلى المفضلة لهذا السجل باستخدام الرموز الموجودة على يمين اسم السجل. - تتوفر إجراءات إضافية في القائمة المنسدلة "إجراءات" الموجودة على يمين الزر "تحرير".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'تتيح لك الوحدة النمطية {{plural_module_name}} إمكانية تتبع مبيعات الأفراد وعناصر الخط التي تنتمي لعمليات البيع تلك من البداية للنهاية. كل سجل من سجلات {{module_name}} يمثل عملية بيع محتملة، كما يتضمن بيانات بيع ذات صلة، كما يتعلق بالسجلات المهمة الأخرى مثل {{quotes_module}} ،{{contacts_module}}، إلخ.

لإنشاء {{module_name}}:
1. قم بتوفير القيم المطلوبة للحقول حسب الرغبة.
