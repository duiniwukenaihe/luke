...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}モジュールは個別の商談を開始から終了まで追跡することができます。各{{module_name}}のレコードは見込みのある商談を表し、関連する営業データと{{quotes_module}}、{{contacts_module}}などその他の重要なレコードを含みます。{{module_name}}は通常「受注済み」または「失注済み」としてマークされるまでいくつかの商談ステージを経て進行します。{{plural_module_name}}をさらに活用するために、Sugarの {{forecasts_singular_module}} するモジュールを使用して販売トレンドを理解および予測し、販売ノルマを達成するための業務に焦点を当てることができます。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} モジュールは個別の販売とそれらの販売に付随する商品を最初から最後まで追跡できます。各{{module_name}} のレコードは見込みのある販売を表し、関連する販売データと{{quotes_module}}、{{contacts_module}} などその他の重要なレコードを含みます。

- 個別のフィールドか編集ボタンをクリックすると、このレコードのフィールドが編集できます。
- 左下のペインを「データビュー」 に切り替えることでサブパネルにある他のレコードへのリンクを閲覧または修正します。
- 左下のペインを「アクティビティストリーム」 に切り替えることでユーザーコメントおよびレコードの変更履歴を{{activitystream_singular_module}} で作成および閲覧します。
- レコード名の右にあるアイコンでこのレコードをフォローまたはお気に入り登録します。
- 編集ボタン右のアクションメニューのドロップダウンリストから追加のアクションにアクセスできます。',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} モジュールは個別の販売とそれらの販売に付随する商品を最初から最後まで追跡できます。各{{module_name}} のレコードは見込みのある販売を表し、関連する販売データと{{quotes_module}}、{{contacts_module}} などその他の重要なレコードを含みます。

{{module_name}} を作成するには：
1. フィールドに必要に応じて値を入力します。
 -「必須」とマークされたフィールドは保存前に入力されなくてはなりません。
 - 必要な場合は「さらに表示」をクリックして追加のフィールドを出現させてください。
2. 「保存」をクリックして新しいレコードを確定し、前のページに戻ります。',
