...
- Чтобы редактировать поля этой записи, щелкните нужное поле или нажмите кнопку «Редактировать».
- Чтобы просмотреть или изменить ссылки на другие записи на субпанеле, переключите левую нижнюю панель на «Просмотр данных». 
- Чтобы оставлять и просматривать комментарии пользователей, а также историю изменения записи в модуле {{activitystream_singular_module}}, переключите левую нижнюю панель на «Ленту активностей».
- Чтобы подписаться на данную запись или добавить ее в избранное, используйте значки справа от имени записи.
- Дополнительные действия доступны в раскрывающемся меню «Действия» справа от кнопки «Редактировать».',
...
1. Укажите необходимые значения полей.
 ...
 - Нажмите кнопку «Показать больше», чтобы отобразить дополнительные поля при необходимости.
