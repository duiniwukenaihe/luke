...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'โมดูล {{plural_module_name}} ช่วยให้คุณสามารถติดตามการขายจากแต่ละรายการตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงการขายที่มุ่งหวัง และรวมข้อมูลการขายที่เกี่ยวข้อง ตลอดจนระเบียนสำคัญอื่นๆ ที่เกี่ยวข้องเช่น {{quotes_module}}, {{contacts_module}} เป็นต้น ตามปกติ {{module_name}} จะเข้าสู่ขั้นตอนต่างๆ ของการขายจนกระทั่งมีการทำเครื่องหมายว่า "ปิดโดยได้รับการขาย" หรือ "ปิดโดยไม่ได้รับการขาย" โดยสามารถใช้ประโยชน์จาก {{plural_module_name}} เพิ่มเติมได้อีกด้วยการใช้โมดูล {{forecasts_singular_module}} ของ Sugar เพื่อทำความเข้าใจและคาดการณ์แนวโน้มการขาย และเน้นการทำงานเพื่อให้บรรลุโควต้าการขาย',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'โมดูล {{plural_module_name}} ช่วยให้คุณติดตามการขายแต่ละรายการและบรรทัดรายการของการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงการขายที่มุ่งหวัง และรวมข้อมูลการขายที่เกี่ยวข้อง ตลอดจนระเบียนสำคัญอื่นๆ ที่เกี่ยวข้อง เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น

- แก้ไขฟิลด์ของเรคคอร์ดนี้โดยคลิกที่แต่ละฟิลด์หรือคลิกปุ่มแก้ไข
- ดูหรือแก้ไขลิงก์ไปยังระเบียนอื่นๆ ในแผงข้อมูลย่อยโดยสลับแผงด้านซ้ายล่างเป็น "มุมมองข้อมูล"
...
- การดำเนินการอื่นๆ จะอยู่ในเมนูการดำเนินการแบบดรอปดาวน์ทางขวาของปุ่มแก้ไข',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'โมดูล {{plural_module_name}} ช่วยให้คุณสามารถติดตามการขายแต่ละรายการ และบรรทัดรายการที่อยู่ในการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงการขายที่มุ่งหวัง และรวมข้อมูลการขายที่เกี่ยวข้อง ตลอดจนระเบียนสำคัญอื่นๆ ที่เกี่ยวข้อง เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น
