<?php
    ...
    $fields = array(
        'docusign_authentication_type' => array(
            'name' => 'docusign_authentication_type',
            'type' => 'enum',
            'label' => 'LBL_RT_DOCUSIGN_USER_AUTHENTICATION_TYPE',
            'options' => array('global' => 'Global', 'user' => 'User',),
            'view' => 'edit',
            'default' => false,
            'enabled' => true,
            'required' => false,
    ...
    $viewdefs['RT_DocuSign']['base']['view']['dsconfig'] = array(
        'panels' => array(
            array(
