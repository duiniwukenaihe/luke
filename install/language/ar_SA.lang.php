...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'دعم قاعدة البيانات غير متوفر. يرجى التأكد من توفر برامج التشغيل اللازمة لأحد أنواع قاعدة البيانات المدعومة التالية: MySQL أو MS SQLServer أو Oracle أو DB2. قد تحتاج إلى إلغاء التعليق على الامتداد الموجود في ملف php.ini أو إعادة التجميع باستخدام الملف الثنائي الصحيح، وفقًا لإصدار PHP. يرجى الرجوع إلى دليل PHP لمزيد من المعلومات حول كيفية تمكين دعم قاعدة البيانات.',
...
<li>/تحميل</b></li></ul></li></ul>
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'أقل إصدار PHP مطلوب هو 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(إصدار PHP الحالي ',
    'LBL_RECOMMENDED_PHP_VERSION' =>' إصدار PHP الموصى به هو 7.1.x)',
