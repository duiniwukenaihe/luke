...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Bulunamadı: Sugar Planlayıcı, sınırlı fonksiyonla çalışacak. E-posta Arşivleme hizmeti çalışmayacak.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veri tabanı desteği bulunamadı. Lütfen aşağıdaki desteklenen Veri Tabanları Türlerinden bir tanesinin gerekli sürücülerine sahip olduğunuzdan emin olun: MySQL, MS SQLServer, Oracle, or DB2. php.ini dosyasındaki uzantı açıklamasını kaldırmanız veya PHP sürümünüze bağlı olarak doğru ikili dosyayı yeniden derlemeniz gerekebilir. Veri Tabanı Desteğini nasıl etkinleştireceğinizle ilgili daha fazla bilgi için lütfen PHP Kılavuzunuza bakın.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Gerekli minimum PHP sürümü 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Mevcut php versiyonunuz',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Önerilen php sürümü 7.1.x)',
