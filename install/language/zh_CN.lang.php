...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到数据库支持。请确保您已安装支持以下任一数据库类型所需的驱动程序：MySQL、MS SQLServer、Oracle，或 DB2。您可能需要移除 php.ini 文件中有关扩展的注释，或使用正确的二进制文件进行编译，具体视您的 PHP 版本而定。更多关于如何启用数据库支持的信息，请参考您的 PHP 手册。',
...
<li> 弹性搜索端口指的是连接到搜索引擎的端口数。其默认值为9200。</li>
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'PHP 版本的最低要求是 5.6.0。',
	'LBL_YOUR_PHP_VERSION' => '(您当前的 PHP 版本是',
    'LBL_RECOMMENDED_PHP_VERSION' =>'建议 php 版本为 7.1.x)',
