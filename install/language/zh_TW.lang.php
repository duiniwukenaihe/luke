...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> '未找到：Sugar 工作計畫可以使用的功能有限。電子郵件歸檔服務將無法法使用。',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到數據庫支援。請確保您已安裝支援以下任一數據庫類型所需的驅動程式：MySQL、MS SQLServer、Oracle，或 DB2。您可能需要移除 php.ini 文件中有關擴展的注釋，或使用正確的二進制文件進行編譯，具體將視您的 PHP 版本而定。更多關於如何啟用數據庫支援的訊息，請參考您的 PHP 手冊。',
...
<li>/upload</b></li></ul></li></ul>
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'PHP 版本的最低要求為 5.6.0。',
	'LBL_YOUR_PHP_VERSION' => '（您目前的 php 版本是',
    'LBL_RECOMMENDED_PHP_VERSION' =>' 建議 Php 版本為 7.1.x)',
