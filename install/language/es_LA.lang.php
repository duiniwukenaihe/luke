...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'No encontrado: El programador de Sugar se ejecutara con funcionalidad limitada. El servicio de Archivado de Correo Electrónico no funciona.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se encontró el Soporte de la Base de Datos.  Por favor, asegúrese de tener los instaladores necesarios para uno de los siguientes tipos de base de datos: MySQL, MS SQLServer, Oracle o DB2.  Podría necesitar remover el comentario de  la extensión en el archivo php.ini o recompilar con el archivo binario correcto, dependiendo de la versión de PHP.  Por favor consulte el Manual de PHP para obtener más información sobre cómo habilitar la compatibilidad con la base de datos.',
...
<li><b>Juego de Caracteres</b> más comúnmente usado en su configuración regional.<br><br></li></ul>                                  Para información más detallada, por favor, consulte la Guía de Instalación.                                ",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'La versión de PHP mínima requerida es la 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Su versión actual de PHP es',
    'LBL_RECOMMENDED_PHP_VERSION' =>' La versión de Php recomendada de Php es la 7.1.x)',
