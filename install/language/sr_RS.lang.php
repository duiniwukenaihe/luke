...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Nije pronađeno: Sugar zakazivanje će funkcionisati sa ograničenom funkcionalnošću. Usluga arhiviranja e-pošte neće biti pokrenuta.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Podrška baze podataka nije pronađena. Proverite da li imate potrebne upravljačke programe za jedan od sledećih podržanih tipova baze podataka: MySQL, MS SQLServer, Oracle ili DB2. Možda je potrebno da opozovete komentar proširenja u datoteci php.ini ili da ponovo kompajlirajte pomoću odgovarajuće binarne datoteke, u zavisnosti od verzije PHP-a. Više informacija o omogućavanju podrške baze podataka potražite u PHP priručniku.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Minimalna potrebna PHP verzija je 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Vaša aktuelna PHP verzija je',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Preporučena php verzija je 7.1.x)',
