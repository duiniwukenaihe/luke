...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Tietokantatukea ei löytynyt. Varmista, että sinulla on jonkin seuraavan tuetun tietokannan tarvittavat ohjain: MySQL, MS SQLServer, Oracle tai DB2. Tarvittaessa poista kommentti php.ini-tiedoston laajennuksesta tai käännä uudelleen oikealla binaaritiedostolla PHP:n versiosta riippuen. Katso lisätietoa tietokantatuen käyttöön ottamisesta PHP-oppaasta.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Tarvittava PHP-versio on vähintään 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Nykyinen PHP-versiosi on',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Suositeltu PHP:n versio on 7.1.x)',
