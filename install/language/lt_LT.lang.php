...
$mod_strings = array(
	...
	'ERR_OC_SERVER_URL'					=> '„Sugar“ serverio URL yra privalomas.',
	'ERR_OC_USERNAME'					=> 'Serverio vartotojo vardas yra privalomas.',
	'LBL_INSTALL_OC'					=> 'Įdiekite autonominį klientą',
    'LBL_OC_ADMIN'                      => 'Kreipkitės į administratorių, kad padėtų išspręsti šią problemą.',
    'LBL_OC_SUCCESS'                    => 'Autonominio klientas diegimas baigtas. Spustelėkite žemiau esantį mygtuką ir persijungsite į įdiegtą programą.',
	'LBL_OC_INSTALL_ADMIN_NAME'			=> 'Administratoriaus vartotojo vardas',
	'LBL_OC_INSTAL_DIRECTIONS'			=> 'Žmiau įveskite išsamią informaciją, kad autonominis klientas būtų tinkamai įdiegtas ir sinchronizuotas.',
	'LBL_OC_INSTALL_SERVER_URL'			=> '„Sugar“ serverio URL',
	'LBL_OC_INSTALL_PASS'				=> 'Serverio vartotojo slaptažodis',
	'LBL_OC_INSTALL_TITLE'				=> 'Autonominio kliento diegimas',
	'LBL_OC_INSTALL_USERNAME_DETAILS'	=> 'Naudodamiesi šiuo vartotojo vardu jungsitės prie „Sugar“ serverio.',
	'LBL_OC_INSTALL_USERNAME'			=> 'Vartotojo vardas',
	'LBL_PERFORM_OC_INSTALL'			=> 'Inicijuojamas autonominio kliento diegimas',
    'LBL_OC_INSTALL_DIRECTIONS'         => 'Žmiau įveskite išsamią informaciją, kad autonominis klientas būtų tinkamai įdiegtas ir sinchronizuotas.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Nerasta duomenų bazės palaikymo. Įsitikinkite, kad turite būtinas tvarkykles, skirtas vienam iš šių palaikomų duomenų bazės tipų: „MySQL“, „MS SQLServer“, „Oracle“ ar DB2. Atsižvelgiant į jūsų PHP versiją, gali reikėti anuliuoti plėtinio komentarus faile php.ini arba iš naujo sukompiliuoti su tinkamu dvejetainiu failu. Daugiau informacijos apie duomenų bazės palaikymo įgalinimą žr. PHP žinyne.',
	...
	'ERROR_FLAVOR_INCOMPATIBLE'			=> 'Nusiųstas failas nesuderinamas su šia „Sugar“ versijos konfigūracija („Community“, „Professional“ ar „Enterprise“): ',
	...
	'LBL_LICENSE_OC_DIRECTIONS'			=> 'Įveskite nupirktų autonominių klientų licencijų skaičių.',
	'LBL_LICENSE_OC_NUM'				=> 'Autonomių klientų licencijų skaičius',
	'LBL_LICENSE_OC'					=> 'Autonomių klientų licencijos',
...
<br> Ištaisykite <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>PHP konfigūraciją</a>  faile php.ini, pateiktame žemiau.",
	...
	'LBL_INCOMPATIBLE_PHP_VERSION' => 'Reikalinga PHP 5 versija arba naujesnė.',
    'LBL_MINIMUM_PHP_VERSION' => 'Reikalinga bent PHP 5.6.0 versija.',
	'LBL_YOUR_PHP_VERSION' => '(Jūsų dabartinė php versija yra',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Rekomenduojama PHP 7.1.x versija)',
