...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Introuvable : le planificateur Sugar sera exécuté avec une fonctionnalité réduite. Le service d\'archivage automatique d\'e-mails ne sera pas exécuté.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Support de base de données introuvable. Veuillez vous assurer que vous avez les pilotes nécessaires pour un des suivants types de base de données pris en charge suivants ; MySQL, MS SQLServer, Oracle, ou DB2. Il se peut que vous deviez décommenter l\'extension dans le fichier php.ini, ou recompiler avec le fichier binaire correct, selon votre version de PHP. Veuillez consulter votre manuel PHP pour plus d\'informations sur la façon d\'activer le support de base de données.',
...
<li>/upload</b></li></ul></li></ul>
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'La version PHP minimale requise est 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Votre version courrante de PHP est la',
    'LBL_RECOMMENDED_PHP_VERSION' =>' La version PHP recommandée est 7.1.x)',
