...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'No encontrado: programador de Sugar operará con funcionalidad limitada. El servicio de archivado de correo electrónico no funcionará.',
...
<br> Corrija su <a target=_new href=\"http://us2.php.net/manual/en/ref.session.php\">configuración PHP</a> en el archivo php.ini ubicado a continuación.",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'La versión mínima requerida de PHP es la 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Su versión actual de PHP es',
    'LBL_RECOMMENDED_PHP_VERSION' =>' La versión recomendada de php es la 7.1.x)',
