...
$mod_strings = array(
	...
	'ERR_OC_SERVER_URL'					=> 'Vyžaduje sa URL servera Sugar.',
	'ERR_OC_USERNAME'					=> 'Vyžaduje sa meno používateľa servera.',
	'LBL_INSTALL_OC'					=> 'Nainštalujte Offline klienta',
    'LBL_OC_ADMIN'                      => 'Na účel vyriešenia tohto problému kontaktujte svojho administrátora.',
    'LBL_OC_SUCCESS'                    => 'Inštalácia Offline klienta bola dokončená. Kliknite na tlačidlo uvedené ďalej a pokračujte v inštalácii.',
	'LBL_OC_INSTALL_ADMIN_NAME'			=> 'Meno používateľa v role administrátora',
	'LBL_OC_INSTAL_DIRECTIONS'			=> 'Zadajte nižšie podrobnosti, aby sa správne nainštaloval a synchronizoval váš Offline klient.',
	'LBL_OC_INSTALL_SERVER_URL'			=> 'URL servera Sugar',
	'LBL_OC_INSTALL_PASS'				=> 'Heslo pre používateľa servera',
	'LBL_OC_INSTALL_TITLE'				=> 'Inštalácia Offline klienta',
	'LBL_OC_INSTALL_USERNAME_DETAILS'	=> 'Toto je meno používateľa, pomocou ktorého sa pripojíte k serveru Sugar.',
	'LBL_OC_INSTALL_USERNAME'			=> 'Meno používateľa',
	'LBL_PERFORM_OC_INSTALL'			=> 'Inicializácia inštalácie Offline klienta',
    'LBL_OC_INSTALL_DIRECTIONS'         => 'Zadajte nižšie podrobnosti, aby sa správne nainštaloval a synchronizoval váš Offline klient.',
	...
	'ERR_CHECKSYS_CURL'					=> 'Nepodarilo sa nájsť: Plánovač Sugar sa spustí s obmedzenou funkčnosťou. Služba Archivovanie e-mailov nebude fungovať.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Podpora databázy sa nenašla. Uistite sa, že máte potrebné ovládače pre jeden z nasledujúcich typov databázy: MySQL, MS SQLServer, Oracle, alebo DB2. V závislosti od vašej verzie PHP možno budete musieť povoliť rozšírenie v súbore php.ini alebo ho prekompilovať správnym binárnym súborom. Informácie o povolení podpory databázy nájdete v príručke k PHP.',
	...
	'ERROR_FLAVOR_INCOMPATIBLE'			=> 'Nahratý súbor nie je kompatibilný s týmto typom (Community Edition, Professional alebo Enterprise) aplikácie Sugar: ',
...
Nainštalované',
	...
	'LBL_LICENSE_OC_DIRECTIONS'			=> 'Zadajte počet zakúpených Offline klientov.',
	'LBL_LICENSE_OC_NUM'				=> 'Počet licencií pre Offline klientov',
	'LBL_LICENSE_OC'					=> 'Licencie Offline klientov',
...
<br><br>Bežne nesprávna konfigurácia nastane, keď direktíva <b>session.save_path</b> nesmeruje k platnému adresáru.<br><br>Opravte<a target=_new href='http://us2.php.net/manual/en/ref.session.php'> PHP konfiguráciu</a> v súbore php.ini umiestnenom tu nižšie.",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Minimálna verzia PHP je 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Vaša aktuálna verzia php je ',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Odporúčaná verzia php je 7.1.x)',
