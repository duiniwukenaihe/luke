...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'No s\'ha trobat: Sugar Scheduler s\'executarà amb funcionalitat limitada. El servei d\'arxivat de correus electrònics no s\'executarà.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No s\'ha trobat compatibilitat amb la base de dades. Comprovi que disposa dels controladors necessaris per un dels següents tipus de base de dades compatibles: MySQL, MS SQLServer, Oracle o DB2.  És possible que hagi de descomentar l\'extensió de l\'arxiu php.ini, o recompilar amb l\'arxiu binari correcte, depenent de la seva versió de PHP. Consulti el manual PHP per obtenir més informació sobre com activar la compatibilitat de bases de dades.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'La versió PHP mínima requerida és 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(La seva versió actual de PHP és',
    'LBL_RECOMMENDED_PHP_VERSION' =>' La versió php recomanada és 7.1.x)',
