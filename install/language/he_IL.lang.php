...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'תמיכת מסד הנתונים לא נמצאה. נא ודא שברשותך מנהלי ההתקנים הנחוצים עבור אחד מסוגי מסדי הנתונים הנתמכים הבאים: MySQL‏, MS SQLServer‏, Oracle או DB2. ייתכן שתצטרך לבטל את הסימון כהערה של סיומת קובץ ה-php.ini, או להדר מחדש עם הקובץ הבינארי הנכון בהתאם לגרסת PHP שלך. נא עיין במדריך PHP לקבלת מידע נוסף אודות הדרך לאפשר תמיכת מסד נתונים.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'גרסת ה-PHP המינימלית הנדרשת היא 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Your current php version is',
    'LBL_RECOMMENDED_PHP_VERSION' =>' גרסת ה-php המומלצת היא 7.1.x)',
