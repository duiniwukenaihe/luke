...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Ikke fundet: Sugar Scheduler vil køre med begrænset funktionalitet. Tjenesten e-mail-arkivering vil ikke køre.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasesupport blev ikke fundet.  Sørg for, at du har de nødvendige drivere til en af følgende understøttede databasetyper: MySQL, MS SQLServer, Oracle og DB2.  Du skal måske afkommentere udvidelsen i php.ini filen eller rekompilere med den rigtige binære fil, afhængigt af din version af PHP.  Se din PHP manual for mere information om hvordan du aktiverer  databaseunderstøttelse.',
...
<br> Ret din <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>PHP-konfiguration</a> i filen php.ini, som er placeret her nedenfor.",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Mindste krævede PHP-version er 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '"Din aktuelle php-version er',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Den anbefalede php-version er 7.2x)',
