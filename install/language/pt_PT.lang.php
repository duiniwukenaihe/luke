...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O Suporte da Base de Dados não foi encontrado. Certifique-se de que possui os controladores necessários para um dos seguintes Tipos de Base de Dados suportados: MySQL, MS SQLServer, Oracle ou DB2.  Talvez seja necessário anular o comentário da extensão no ficheiro php.ini ou recompilar com ficheiro binário correcto, consoante a sua versão de PHP.  Consulte o Manual do PHP para mais informações sobre como ativar o Suporte da Base de Dados.',
...
<li> A porta de Elasticsearch é o número da porta da ligação do Sugar ao motor de busca. O valor padrão é 9200, que é o valor padrão do elasticsearch. </li>
    ...
    'LBL_RECOMMENDED_PHP_VERSION' =>' A versão PHP recomendada é 7.1.x)',
