...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Nuk u gjet: Planifikuesi i "Sugar" do të ekzekutohet me funksione të kufizuara. Shërbimi i arkivimit të emaileve nuk do të ekzekutohet.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Nuk u gjet mbështetje për databazën.  Sigurohu që të kesh të gjithë drejtuesit e nevojshëm softuerikë për një nga llojet e mëposhtme të mbështetur të databazave: MySQL, MS SQLServer, Oracle ose DB2. Mund të të duhet të shkomentosh mbaresën përkatëse në skedarin php.ini ose të rikompilosh skedarin e përshtatshëm binar, në varësi të versionit tënd të PHP.  Shih manualin përkatës të PHP për informacionin rreth mënyrës së aktivizimit të mbështetjes për databazën.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Versioni minimal i kërkuar i PHP është 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Versioni php i juaji aktual është',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Versioni i rekomanduar i PHP është 7.1.x)',
