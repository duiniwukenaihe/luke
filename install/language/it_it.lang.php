...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Non trovato: lo schedulatore di Sugar sarà eseguito con funzionalità limitata. Il servizio di archiviazione e-mail non sarà eseguito.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Supporto database non trovato. Verificare di disporre dei driver necessari per uno dei seguenti tipi di database supportati: MySQL, MS SQLServer, Oracle o DB2.  Potrebbe essere necessario decommentare l\'estensione nel file php.ini o ricompilarla con il file in binario corretto, a seconda della versione di PHP. Consultare il manuale di PHP per ulteriori informazioni su come attivare il supporto database.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'La versione minima di PHP è 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(La versione attuale di php è',
    'LBL_RECOMMENDED_PHP_VERSION' =>' La versione consigliata di PHP è 7.1.x)',
