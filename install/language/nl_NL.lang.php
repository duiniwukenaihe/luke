...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Niet gevonden: Sugar Scheduler wordt uitgevoerd met beperkte functionaliteit. De dienst E-mailarchivering wordt niet uitgevoerd.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databaseondersteuning werd niet gevonden. Controleer of u de nodige stuurprogramma\'s hebt voor een van de volgende ondersteunde types databases: MySQL, MS SQLServer, Oracle of DB2. Mogelijk moet u de extensie in het php.ini bestand verwijderen of opnieuw opstellen met het juiste binaire bestand, afhankelijk van uw versie van PHP. Raadpleeg uw PHP-handleiding voor meer informatie over hoe u databaseondersteuning inschakelt.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Minimaal benodigde PHP-versie is 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Uw huidige php versie is',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Aanbevolen Php-versie is 7.1.x)',
