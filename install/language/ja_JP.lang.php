...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> '見つかりません: 機能を限定してSugarスケジューラを実行します。メール アーカイブ サービスは実行されません。',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'データベースのサポートが見つかりませんでした。 次のサポートされているデータベース タイプの 1 つのために必要なドライバーがあるか確認してください: MySQL、MS SQLServer、Oracle、またはDB2。お使いのPHP のバージョンによっては、Php.ini ファイルの拡張のコメント扱いを解除するか、適切なバイナリ ファイルを再コンパイルする必要があります。 データベースのサポートを有効にする方法の詳細については、PHP マニュアルを参照してください。',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'PHPのバージョンは5.6.0以上である必要があります。',
	'LBL_YOUR_PHP_VERSION' => '（現在のPHPバージョンは',
    'LBL_RECOMMENDED_PHP_VERSION' =>' 推奨するphpバージョンは7.1.x以上です。)',
