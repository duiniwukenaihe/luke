...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Obsługa bazy danych nie została znaleziona. Upewnij się, że masz niezbędne sterowniki dla jednego z następujących obsługiwanych typów baz danych: MySQL, MS SQLServer, Oracle lub DB2. Może będziesz musiał odkomentować rozszerzenie w pliku php.ini lub ponownie skompilować całość z odpowiednim plikiem binarnym, w zależności od wersji PHP. Więcej informacji na temat włączania obsługi bazy danych można uzyskać w Podręczniku PHP.',
...
<br> Popraw <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>konfigurację PHP</a> w pliku php.ini znajdującym się poniżej.",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Minimalna wymagana wersja PHP to 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Twoja aktualna wersja PHP to',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Zalecana wersja PHP to 7.1.x)',
