...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Не е намерено: Графикът на дейностите на Sugar ще работи с ограничена функционалност. Услугата за архивиране на електронната поща не работи.',
...
<br> Please correct your <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>PHP configuration</a> in the php.ini file located here below.",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Изисква се версията на PHP да е минимум 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Текущата инбсталирана версия е',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Препоръчваната версия на php е 7.1.x)',
