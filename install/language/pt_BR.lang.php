...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Não encontrado: O agendador do Sugar funcionará com recursos limitados. O serviço de arquivamento de e-mail não será executado.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O suporte do banco de dados não foi encontrado. É necessário ter os drivers necessários para um dos seguintes tipos de banco de dados suportados: MySQL, MS SQLServer, Oracle ou DB2.  Talvez seja necessário remover o comentário da extensão no arquivo php.ini ou recompilar com o arquivo binário correto, dependendo da versão do PHP.  Consulte o Manual do PHP para mais informações sobre como ativar o suporte do banco de dados.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'A versão do PHP mínima necessária é 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(A sua versão PHP atual é',
    'LBL_RECOMMENDED_PHP_VERSION' =>' A versão do PHP recomendada é 7.1.x)',
