...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Finner ikke: Sugar Scheduler vil kjøres med begrenset funksjonalitet. Tjenesten for e-postarkivering kjøres ikke.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Finner ikke database-støtte.  Kontroller at du har de nødvendige driverne for en av følgende støttede databasetyper: MySQL, MS SQL, Oracle eller DB2.  Du må kanskje fjerne kommentar fra utvidelsen i filen php.ini, eller rekompilere med riktig binærfil, avhengig av din versjon av PHP.  Se PHP-håndboken for mer informasjon om hvordan du aktiverer databasestøtte.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Minste PHP-versjon som kreves er 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Din nåværende php versjon er',
    'LBL_RECOMMENDED_PHP_VERSION' =>' Anbefalt php-versjon er 7.1.x)',
