...
$mod_strings = array(
	...
	'ERR_OC_PASSWORD'					=> 'Parool on nõutav.',
	'ERR_OC_SERVER_URL'					=> 'Sugari serveri URL on nõutav.',
	'ERR_OC_USERNAME'					=> 'Serveri kasutaja kasutajanimi on nõutav.',
	'LBL_INSTALL_OC'					=> 'Installi ühenduseta klient',
    'LBL_OC_ADMIN'                      => 'Probleemi lahendamiseks võtke ühendust oma administraatoriga.',
    'LBL_OC_SUCCESS'                    => 'Ühenduseta kliendi installimine on lõpetatud. Installimisse viimiseks klõpsake allolevat nuppu.',
	'LBL_OC_INSTALL_ADMIN_NAME'			=> 'Admini kasutajanimi',
	'LBL_OC_INSTAL_DIRECTIONS'			=> 'Ühenduseta kliendi õigesti installimiseks ja sünkroonimiseks sisestage järgmised üksikasjad.',
	'LBL_OC_INSTALL_SERVER_URL'			=> 'Sugari serveri URL',
	'LBL_OC_INSTALL_PASS'				=> 'Serveri kasutaja salasõna',
	'LBL_OC_INSTALL_TITLE'				=> 'Ühenduseta kliendi installimine',
	'LBL_OC_INSTALL_USERNAME_DETAILS'	=> 'See on kasutajanimi, millega Sugari serveri ühendate.',
	'LBL_OC_INSTALL_USERNAME'			=> 'Kasutajanimi',
	'LBL_PERFORM_OC_INSTALL'			=> 'Ühenduseta kliendi installimise lähtestamine',
    'LBL_OC_INSTALL_DIRECTIONS'         => 'Ühenduseta kliendi õigesti installimiseks ja sünkroonimiseks sisestage järgmised üksikasjad.',
	...
	'ERR_CHECKSYS_CURL'					=> 'Ei leitud: Sugar Scheduler töötab piiratud mahus. E-kirjade arhiivimise teenus ei tööta.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Andmebaasituge ei leitud. Veenduge, et teil oleks olemas draiverid ühe jaoks järgnevatest toetatud andmebaasidest: MySQL, MS SQLServer, Oracle või DB2. Olenevalt teie PHP versioonist võib olla tarvis sisse kommenteerida laiendus php.ini failis või õige kahendfailiga uuesti kompileerida. Lisateavet andmebaasitoe aktiivseks muutmise kohta leiate oma PHP juhendist.',
	...
	'LBL_LICENSE_OC_DIRECTIONS'			=> 'Sisestage ostnud ühenduseta klientide arv.',
	'LBL_LICENSE_OC_NUM'				=> 'Ühenduseta klientide litsentside arv',
	'LBL_LICENSE_OC'					=> 'Ühenduseta kliendi litsentsid',
...
<br> Parandage oma <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>PHP konfiguratsioon</a> siin allpool toodud failis php.ini.",
    ...
    'LBL_MINIMUM_PHP_VERSION' => 'Minimaalne nõutav PHP versioon on 5.6.0.',
	'LBL_YOUR_PHP_VERSION' => '(Teie praegune php versioon on ',
    'LBL_RECOMMENDED_PHP_VERSION' =>'Soovitatav PHP versioon on 7.1.x)',
