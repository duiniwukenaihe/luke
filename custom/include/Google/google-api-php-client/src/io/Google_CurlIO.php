...
require_once 'custom/include/Google/google-api-php-client/src/io/Google_CacheParser.php';
...
class Google_CurlIO implements Google_IO
{
    ...
    public function makeRequest(Google_HttpRequest $request)
    {
        ...
        if (curl_errno($ch) == CURLE_SSL_CACERT) {
            ...
            $tmp[0]('SSL certificate problem, verify that the CA cert is OK.'
    ...
    public function getCachedRequest(Google_HttpRequest $request)
    {
        ...
        return Google_Client::$cache->getA($request->getCacheKey());
    }
