...
require_once 'custom/include/Google/google-api-php-client/src/config.php';
// If a local configuration file is found, merge it's values with the default configuration
//if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
if (SugarAutoloader::fileExists(dirname(__FILE__) . '/local_config.php')) {
...
require_once 'custom/include/Google/google-api-php-client/src/service/Google_Model.php';
require_once 'custom/include/Google/google-api-php-client/src/service/Google_Service.php';
require_once 'custom/include/Google/google-api-php-client/src/service/Google_ServiceResource.php';
require_once 'custom/include/Google/google-api-php-client/src/auth/Google_AssertionCredentials.php';
require_once 'custom/include/Google/google-api-php-client/src/auth/Google_Signer.php';
require_once 'custom/include/Google/google-api-php-client/src/auth/Google_P12Signer.php';
require_once 'custom/include/Google/google-api-php-client/src/service/Google_BatchRequest.php';
require_once 'custom/include/Google/google-api-php-client/src/external/URITemplateParser.php';
require_once 'custom/include/Google/google-api-php-client/src/auth/Google_Auth.php';
require_once 'custom/include/Google/google-api-php-client/src/cache/Google_Cache.php';
require_once 'custom/include/Google/google-api-php-client/src/io/Google_IO.php';
require_once 'custom/include/Google/google-api-php-client/src/service/Google_MediaFileUpload.php';
