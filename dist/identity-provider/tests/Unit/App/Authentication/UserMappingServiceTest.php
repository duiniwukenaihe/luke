 ...
 *
 * @coversDefaultClass Sugarcrm\IdentityProvider\App\Authentication\UserMappingService
 */
class UserMappingServiceTest extends PHPUnit_Framework_TestCase
{
    /**
     * @covers ::map
    ...
    public function testMap($mappingConfig, $attributes, $nameId, $expected)
    {
        ...
        $mapping = new UserMappingService($mappingConfig);
    ...
    {
        $mapping = $this->getMockBuilder(UserMappingService::class)
