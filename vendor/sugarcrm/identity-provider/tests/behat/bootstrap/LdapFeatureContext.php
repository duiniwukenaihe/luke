...
class LdapFeatureContext extends FeatureContext
{
    ...
    public function __construct(array $sugarAdmin, array $ldapConfig)
    {
        ...
        $this->ldapConfigOverride = !empty($ldapConfig['override']) ? $ldapConfig['override'] : [];
    ...
    {
        return !empty($this->ldapConfigOverride[$name]) ? $this->ldapConfigOverride[$name] : $value;
    }
